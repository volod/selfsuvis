...
from pipeline.core import ensure_dir, get_logger, now_iso, settings
from typing import TYPE_CHECKING

if TYPE_CHECKING:
    from pipeline.vision.factory import OpenCLIPTagger, SAMSegmenter
...
def image_to_text_agent(
    ...
    if segmenter and tagger:
        try:
            from pipeline.vision.factory import mask_to_segments
...
def process_frames(
    ...
    if model_type == "openclip_sam":
        from pipeline.vision.factory import SAMSegmenter
