...
from pipeline.media.dedup import dhash, PhashLRU
from pipeline.mapping import build_semantic_environment_graph
from pipeline.storage import QdrantStore, RecentEmbeddingIndex
...
class VideoIndexer:
    ...
    def index_video(
        ...
        try:
            ...
            from pipeline.mapping.gps_registration import gps_to_enu
    ...
    def _make_vehicle_prescreen(self):
        ...
        import numpy as np
        from pipeline.vision.qwen import _VEHICLE_LABELS
    ...
    def _run_asr_pass(
        ...
        from pipeline.core.utils import ensure_dir
