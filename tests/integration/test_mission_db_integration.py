...
def test_upsert_mission_creates_record(conn):
    from pipeline.mission_db import upsert_mission
...
def test_replace_frames_inserts_new_records(conn):
    from pipeline.mission_db import replace_frames
...
def test_mark_mission_finished_sets_done_status(conn):
    from pipeline.mission_db import mark_mission_finished, upsert_mission
...
def test_apply_gps_registration_updates_enu_origin(conn):
    from pipeline.mission_db import apply_gps_registration, upsert_mission
...
def test_apply_gps_registration_propagates_frame_poses(conn):
    from pipeline.mission_db import apply_gps_registration, replace_frames
...
def test_list_frames_after_no_cursor_returns_first_page(conn):
    from pipeline.mission_db import list_frames_after, replace_frames
...
def test_list_frames_after_empty_table_returns_empty(conn):
    from pipeline.mission_db import list_frames_after
