...
async def test_get_last_visits_returns_matching_rows():
    from app.routers.robot import _get_last_visits
...
def test_pose_query_response_has_last_visits_field():
    ...
    from app.routers.robot import PoseQueryResponse, TimelineVisit
...
def test_timeline_visit_model_validation():
    ...
    from app.routers.robot import TimelineVisit
