...
def _import_r1():
    ...
    from scripts.validate_ssl_improvement import recall_at_1
    return recall_at_1
...
def _import_collect():
    from scripts.validate_ssl_improvement import _collect_frames
...
def test_gate_passes_when_two_of_three_pass():
    ...
    from scripts.validate_ssl_improvement import _GATE_VIDEOS, _GATE_DELTA
...
def test_gate_fails_when_only_one_passes():
    from scripts.validate_ssl_improvement import _GATE_VIDEOS
...
def test_gate_threshold():
    ...
    from scripts.validate_ssl_improvement import _GATE_DELTA
