...
class RealtimePilotSettings:
    ...
    vins_fusion_api_url: str = env_str("REALTIME_VINS_FUSION_API_URL", "http://realtime-vins-fusion:8101").strip()
    orbslam3_api_url: str = env_str("REALTIME_ORBSLAM3_API_URL", "http://realtime-orbslam3:8101").strip()
    ...
    voxblox_api_url: str = env_str("REALTIME_VOXBLOX_API_URL", "http://realtime-voxblox:8101").strip()
