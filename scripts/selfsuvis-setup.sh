#!/usr/bin/env bash
# =============================================================================
# selfsuvis-setup.sh — one-shot bootstrap for a complete local run.
#
...
#
# USAGE:
#   ./scripts/selfsuvis-setup.sh [flags]
#
# FLAGS:
...
#   ./scripts/selfsuvis-setup.sh --with-docker
#
...
#   HF_TOKEN=hf_xxxx ./scripts/selfsuvis-setup.sh
#
# AFTER SETUP:
...
#   rm -rf .venv && ./scripts/selfsuvis-setup.sh
#
...
if [[ -n "$HF_TOKEN" ]]; then
  ...
  warn "  export HF_TOKEN=hf_xxxx  &&  ./scripts/selfsuvis-setup.sh"
fi
...
#   ./scripts/selfsuvis-setup.sh --sensor-data-only   # regenerate sidecars
#
