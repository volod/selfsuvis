...
4. [Sensor fusion fundamentals](learning_path/03_sensor_fusion_fundamentals.md)
5. [Sensors and fusion, Steps 9-20](learning_path/04_sensor_steps_09_20.md)
6. [Tracking and mapping, Steps 21-27](learning_path/05_tracking_mapping_steps_21_27.md)
7. [Adaptation and audit, Steps 28-35](learning_path/06_adaptation_eval_steps_28_35.md)
8. [Agentic knowledge flow](learning_path/07_agentic_knowledge_flow.md)
9. [Local run artifact analysis](learning_path/08_local_run_artifact_analysis.md)
...
- [Requirements and status](learning_path/09_probabilistic_state_fusion_requirements.md)
- [Architecture and data flow](learning_path/10_probabilistic_state_fusion_architecture.md)
- [Delivery status and gaps](learning_path/11_probabilistic_state_fusion_implementation_order.md)
- [**Mathematical deep dive**](learning_path/12_probabilistic_fusion_deep_dive.md) ← start here if you want to understand the math
