...
For each video `<name>.mp4` the pipeline writes to `.data/local_runs/<mission_id>/` and related `.data/maps/<mission_id>/` outputs.
...
---
[← Examples](../development/examples.md) | [Performance →](performance.md)
